...
class Storage:
    ...
    def lun_create(self):
        ...
        self.logger.write_to_log('Storage','print','lun_create',('Create LUN successful on NetApp Storage'))
    ...
    def lun_map(self):
        ...
        self.logger.write_to_log('Storage', 'print', 'lun_map', ('LUN map successful on NetApp Storage'))
